      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-24 lg:grid-cols-[1.05fr_1fr] lg:py-32">
        <div className="animate-fade-up">
          ...
          <p className="mt-6 max-w-xl text-lg text-muted-foreground">
            NovaMail is the email API your engineers will actually like. Generate a key, paste three
            lines of code, and ship reliable delivery to a million inboxes by Friday.
          </p>
          ...
          <div className="mt-6 flex items-center gap-6 text-xs text-muted-foreground">
            <span className="inline-flex items-center gap-1.5">
              <Check className="h-3.5 w-3.5 text-success" /> 3,000 free emails / mo
            </span>
            <span className="inline-flex items-center gap-1.5">

    ...
    <div className="mx-auto max-w-7xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Every email NovaMail has sent for your workspace.
        </p>
      </div>
          ...
          {open && (
            <>
              ...
              <dl className="mt-6 space-y-3 text-sm">
                ...
                <Row label="To">
                  <span className="font-mono text-xs">{open.to}</span>
                </Row>
                <Row label="From">
                  <span className="font-mono text-xs">{open.from}</span>
                </Row>
                <Row label="Sent">
                  <span className="text-muted-foreground">{open.sentAt}</span>
                </Row>
                <Row label="Opens">
                  <span>{open.opens}</span>
                </Row>
                <Row label="Clicks">
                  <span>{open.clicks}</span>
                </Row>
              </dl>
              <div className="mt-6">

...
const routes = [
  {
    ...
    description: 'Quickstart, authentication, and reference for the NovaMail transactional email API.',
  ...
  },
  {
    ...
    description: 'Create a NovaMail account and send your first transactional email in under five minutes.',
